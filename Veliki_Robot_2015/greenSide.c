...
char greenDetectionCallbackWithoutRight(unsigned long startTime)
{
...
{
	{{550, 1067, 0}, NORMAL_SPEED, FORWARD, greenDetectionCallbackWithoutRight},		//izlazi iz startnog polja		0
	{{780, 550, 0}, NORMAL_SPEED, FORWARD, greenDefaultFrontDetectionCallback},			//ide na poziciju prvog valjka	1
	{{1240, 590, 0}, NORMAL_SPEED, FORWARD, greenDetectionCallbackwithoutLeft},			//ide do drugog valjka			2
